...
from Project
--4
select Fname+' '+Lname [full name], Salary*12*0.1 [ANNUAL COMM]
from Employee
--5
select SSN [Id], Fname+' '+Lname [name]
from Employee
where Salary > 1000
--6
select SSN [Id], Fname+' '+Lname [name]
...
--7
select Fname+' '+Lname [name], Salary
from Employee
where Sex = 'F'
--8
select Dnum [department id], Dname [name]
from Departments
where MGRSSN = 968574
--9
select Pnumber [ids], Pname [names], Plocation [locations]
from Project
where Dnum = 10